<?php
/**
 * Template Name: Quản lý dữ liệu sản phẩm (admin)
 *
 * @package willgroup
 */
        ...
        if($fetch_store_products->have_posts()) : ?>
            <div class="container-fluid">
                <div class="MultiCheckBox-Container">
                    <select class="MultiCheckBox" id="user">
                ...
                <div class="MultiCheckBox-Container" id="domain">
                    <select class="MultiCheckBox">
                        <option value="">Chọn tên miền</option>
                        <option value="store.dezital.vn">store.dezital.vn</option>
                        <option value="store.dezital.vn1">store.dezital.vn1</option>
                        <option value="store.dezital.vn2">store.dezital.vn2</option>
                    </select>
                </div>
                <div class="MultiCheckBox-Container">
                ...
                <div class="MultiCheckBox-Container">
                    <select class="MultiCheckBox MultiCheckBox-LoaiDichVu">
                        <?php 
                        $demands = get_terms( array( 'taxonomy' => 're_cat', 'hide_empty' => false, 'parent' => 111 ) ); 
                        foreach ( $demands as $value ) : ?>
                            <option value="<?php echo $value->term_id; ?>">
                                <?php echo $value->name; ?>		
                            </option>
    ...
    <!--                    <th>Đường dẫn</th>-->
        ...
        <div id="detail-analytics-modal" class="detail-analytics-modal">
            ...
            <div class="detail-analytics-modal-content">
                ...
                <table class="detail-analyti cs-product-table display store-hightlight-dataTable">
                    <thead>
                        <tr>
                            <th>Tiêu đề</th>
                    ...
                    <tbody>
                        <?php for ($i = 1; $i <= 30; $i++) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="display: flex;flex-direction: row;align-items: center;justify-content: center">
                                        <a href="nha-dat/moc-khoa-hinh-trai-chuoi-ngo-nghinh-tran-hung-dao/" style="display: flex;margin-right: 10px">
                                            <img class="rounded" style="width: 3.125rem;" src="/wp-content/uploads/2022/07/0206cd34d3efdf866092420139b549b7.jpg" alt="Móc Khóa Hình Trái Chuối Ngộ Nghĩnh Trần Hưng Đạo"/>
                                        </a>
