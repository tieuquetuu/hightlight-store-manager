<?php
/**
 * Template Name: Tổng Quan Số Liệu - Hệ Thống
 *
 * @package willgroup
 */
...
$has_role = is_array($level_manager_user_meta) && in_array("level_3",$level_manager_user_meta);
...
$ajax_source_url = get_rest_url() . "hightlight/v1/reportSystemDataTable?" . $str_params;
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col col-md-3">
                ...
                <input type="text" id="filter-daterange" name="daterange" />
            </div>
